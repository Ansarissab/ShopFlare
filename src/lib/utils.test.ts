...
describe('calculateTax', () => {
  ...
  it('exclusive 17% on subtotal, no discount', () => {
    // 5000 × 0.17 = 850
    expect(calculateTax({ ...base, subtotalCents: 5000, taxRate: 17, taxInclusive: false })).toBe(
      850,
    )
  })
  ...
  it('inclusive 20% extracts tax from post-discount base', () => {
    ...
    expect(calculateTax({ ...base, subtotalCents: 1200, taxRate: 20, taxInclusive: true })).toBe(
      200,
    )
  })
