...
export const fr: Dictionary = {
  ...
  admin: {
    ...
    announcementBarHeading: "Barre d'annonce",
    announcementBarHint:
      'Afficher un avis en haut de votre boutique — soldes, livraison ou info générale.',
    announcementEnabled: "Activer la barre d'annonce",
    announcementType: "Type d'affichage",
    announcementTypeSingle: 'Message unique',
    announcementTypeScheduled: 'Programmé (affichage/masquage automatique)',
    announcementTypeRotating: 'Messages rotatifs',
    announcementMessages: 'Messages',
    announcementMessageText: 'Texte du message',
    announcementMessageLink: 'Lien (optionnel)',
    announcementMessageColor: 'Couleur de fond (optionnel)',
    announcementAddMessage: 'Ajouter un message',
    announcementRemoveMessage: 'Supprimer',
    announcementScheduleStart: 'Afficher à partir de',
    announcementScheduleEnd: 'Masquer après',
  ...
  shortcuts: {
    ...
    goCoupons: 'Aller aux coupons',
    goAnalytics: 'Aller aux statistiques',
    create: 'Créer nouveau',
    listNext: 'Élément suivant',
    listPrev: 'Élément précédent',
    listOpen: 'Ouvrir la sélection',
    storeGroup: 'Boutique',
