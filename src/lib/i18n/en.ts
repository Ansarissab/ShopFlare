export const en = {
  ...
  admin: {
    ...
    landingPageHint: 'Design your store\'s homepage. Toggle sections, set copy and images. Changes apply without redeployment.',
    landingEnabled: 'Enable landing page',
    landingEnabledHint: 'When ON, "/" shows the landing page and "/shop" has the catalog. When OFF, "/" is the catalog.',
    ...
    stylePresetsHint: 'Apply a complete look in one click — colors, font, radius, spacing, and hero layout.',
