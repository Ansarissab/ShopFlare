export const en = {
  ...
  admin: {
    ...
    announcementBarHeading: 'Announcement Bar',
    announcementBarHint:
      'Show a notice at the top of your store — sale, delivery, or general info.',
    announcementEnabled: 'Enable announcement bar',
    announcementType: 'Display type',
    announcementTypeSingle: 'Single message',
    announcementTypeScheduled: 'Scheduled (auto show/hide)',
    announcementTypeRotating: 'Rotating messages',
    announcementMessages: 'Messages',
    announcementMessageText: 'Message text',
    announcementMessageLink: 'Link (optional)',
    announcementMessageColor: 'Background color (optional)',
    announcementAddMessage: 'Add message',
    announcementRemoveMessage: 'Remove',
    announcementScheduleStart: 'Show from',
    announcementScheduleEnd: 'Hide after',
