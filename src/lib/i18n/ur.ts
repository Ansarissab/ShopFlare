...
export const ur: Dictionary = {
  ...
  search: {
    ...
    startTyping: 'تلاش کے لیے ٹائپ کرنا شروع کریں',
    inStockOnly: 'صرف اسٹاک میں موجود',
  ...
  admin: {
    ...
    // announcement bar (phase 29c)
    announcementBarHeading: 'اعلان بار',
    announcementBarHint: 'اپنی دکان کے اوپر ایک اعلان دکھائیں — سیل، ڈیلیوری یا عمومی معلومات۔',
    announcementEnabled: 'اعلان بار فعال کریں',
    announcementType: 'ڈسپلے کی قسم',
    announcementTypeSingle: 'ایک پیغام',
    announcementTypeScheduled: 'وقت مقررہ (خودکار دکھائیں/چھپائیں)',
    announcementTypeRotating: 'گھومتے پیغامات',
    announcementMessages: 'پیغامات',
    announcementMessageText: 'پیغام کا متن',
    announcementMessageLink: 'لنک (اختیاری)',
    announcementMessageColor: 'پس منظر کا رنگ (اختیاری)',
    announcementAddMessage: 'پیغام شامل کریں',
    announcementRemoveMessage: 'ہٹائیں',
    announcementScheduleStart: 'یہاں سے دکھائیں',
    announcementScheduleEnd: 'اس کے بعد چھپائیں',
    ...
    search: {
      placeholder: 'مصنوعات اور آرڈر تلاش کریں…',
      products: 'مصنوعات',
      orders: 'آرڈرز',
  ...
  shortcuts: {
    ...
    hint: '? دبائیں شارٹ کٹس کے لیے',
    search: 'تلاش کریں',
    cart: 'کارٹ کھولیں',
    help: 'یہ مدد دکھائیں',
    close: 'بند کریں',
    goOrders: 'آرڈرز پر جائیں',
    goProducts: 'مصنوعات پر جائیں',
    goCoupons: 'کوپنز پر جائیں',
    goAnalytics: 'تجزیات پر جائیں',
    create: 'نیا بنائیں',
    listNext: 'اگلا آئٹم',
    listPrev: 'پچھلا آئٹم',
    listOpen: 'منتخب کھولیں',
    storeGroup: 'اسٹور فرنٹ',
    adminGroup: 'ایڈمن',
    sequenceHint: 'پھر',
  },
  status: {
