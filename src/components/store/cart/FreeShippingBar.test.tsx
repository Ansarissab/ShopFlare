...
describe('FreeShippingBar', () => {
  ...
  it('shows progress message with remaining amount when below threshold', () => {
    render(<FreeShippingBar subtotalCents={500} thresholdCents={2000} flatRateCents={300} />)
  ...
  it('progress bar is present below threshold', () => {
    render(<FreeShippingBar subtotalCents={1000} thresholdCents={2000} flatRateCents={300} />)
